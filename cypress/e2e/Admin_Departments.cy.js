...
describe("Admin Team Roles", () => {
  ...
  //   it("Verify if the user can remove undefined as department manager", () => {
  //     cy.get(":nth-child(1) > :nth-child(4) > .MuiButtonBase-root")
  //       .scrollIntoView()
  //       .should("be.visible")
  //       .click();
  //     cy.get("#parent-modal-description > :nth-child(7)").click();
  //     departments.buttonVerification(
  //       "Cancel",
  //       cy.get(".Modal_modalButtons__fNdfv > :nth-child(1)")
  //     );
  ...
  //   it("Verify if the user can cancel deleting a department manager", () => {
  //     cy.get(
